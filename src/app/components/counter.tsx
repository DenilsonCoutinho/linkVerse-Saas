  ...
  return (
    <div>
      ...
      {initialDate && initialHour && <div className="flex flex-wrap items-center justify-center md:max-w-[340px] max-w-[300px] gap-2 mt-2">
        ...
        <div className={`bg-white shadow-md md:p-[8px] p-[8px] rounded-md text-xs text-center font-medium`}>
        ...
        <div className={`bg-white shadow-md md:p-[8px] py-[7px] md:w-[97px] w-[85px] rounded-md text-xs text-center font-medium`}>
